...
# Funkcje
   ...
   - Natychmiastowy feedback — zielone/czerwone podświetlenie po każdej odpowiedzi
   - Ekran wyników — wynik procentowy z dynamicznym komunikatem podsumowującym
...
# Features
   ...
   - Instant feedback — green/red highlight after each answer
   - Results screen — score percentage with a dynamic summary message
...
Part of my Frontend Developer learning journey. Previous project: TaskFlow